...
export const metadata = {
  title: 'Blog | Compliance & Business Insights | Easy Approval',
  description: 'Latest updates on GST, company registration, compliance, and business tips from Easy Approval.',
};

export default async function BlogPage() {
  await connectDB();
  const articles = await Article.find({ type: 'blog', isPublished: true })
      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-600">Compliance updates and business insights</p>
          </div>
        </div>
        ...
        <div className="grid gap-6">
          {articles.length === 0 ? (
            <div className="bg-white rounded-lg shadow p-12 text-center text-gray-500">
              <p>Blog posts are being added. Check back soon.</p>
